...
pre_programa <- c(rep("Hostil", 17), rep("No hostil", 3))
...
Al considerar un nivel de significancia α = 0.05 y un p-value = 0.000512, donde p < α. Se rechaza la hipótesis nula. Esto indica que si hay evidencia suficiente para aceptar la hipótesis alternativa indicando que el programa ha sido efectivo para reducir la hostilidad de los villanos.
