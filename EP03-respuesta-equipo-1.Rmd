...
Para identificar la probabilidad de cometer un error de tipo I debemos saber nuestros límites de rechazo, los cuales están planteados en el enunciado.
...
Cómo nos preguntan sobre la cantidad de bidones y que además nos entregan el poder estadístico y el nivel de significación α podemos utilizar la función pwr.norm.test() otorgándole valor NULL al tamaño de la muestra para que nos lo retorne y sepamos la cantidad de bidones.
...
Como ahora nos preguntan sobre las dos máquinas debemos trabajar con dos proporciones, y como también menciona el enunciado es la diferencia entre estas dos proporciones, las cuales también sabemos poseen la misma cantidad de muestra (50 envases c/u). Por lo tanto, debemos trabajar con pwr.2p.test(...)
...
Por el resultado obtenido en la pergunta 4 de muestras de 174 bidones en total, implicaría unos 87 bidones por máquina, los cuales no son suficientes para poder diferenciar entre ambas, puesto que se necesitan al menos 240 bidones para ello.