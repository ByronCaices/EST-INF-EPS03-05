...
```
Si tuviéramos como verdadera media 10,2[L] con los limites establecidos previamente para rechazar la hipótesis nula, la probabilidad de que cometa un error de tipo II sería β: 0.58
...
Por el resultado obtenido en la pergunta 4 de muestras de 174 bidones en total, implicaría unos 87 bidones por máquina, los cuáles no son suficientes para poder diferenciar entre ambas, puesto que se necesitan al menos 240 bidones para ello.