...
Ho:  La media del llenado de los bidones es igual a 10 litros.
Ha: La media de llenado de los bidones es distinta de 10 litros.
    
En lenguaje matemático: como sabemos que muo y mua son la media de llenaodo de los bidones, entonces see puede redactar lo siguiente:
...
g <- g + labs(x = "Litros de detergente [lt]", y = "Densidad")
...
beta_area <- pnorm(Z2, mean = media_verdadera, sd = SEM) - pnorm(Z1, mean = media_verdadera, sd = SEM)
...
dist_v <- stat_function(fun = dnorm,
                        args = list(mean = media_verdadera, sd = SEM),
                        geom = "area",
...
x_ann <- c(media_verdadera, mu)
y_ann <- c(dnorm(media_verdadera, mean = media_verdadera, sd = SEM),
           dnorm(mu, mean = mu, sd = SEM))
y_ann <- y_ann + 0.01
