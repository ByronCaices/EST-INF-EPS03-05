...
Considerando que nos preguntan sobre la cantidad de bidones y que además nos entregan el poder estadístico y el nivel de significación α
...
sigma <- 1  # Desviación estándar poblacional inicial

#media real dado en el problema 2
media_real = 10.2

#Tamaño del efecto d (divide por 1, porque error estandar = 1)
d = (media_real - media_poblacional)
